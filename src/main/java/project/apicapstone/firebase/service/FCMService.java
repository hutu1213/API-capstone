...
import project.apicapstone.firebase.dto.NotificationParameter;
...
//
    public String sendMessageToToken(PushNotificationRequest request)
        ...
        Message message = Message.builder().setToken(request.getToken()).setNotification(new Notification(request.getTitle(), request.getMessage())).build();
