...
@RestController
@RequestMapping("/v1/api/allowance")
public class AllowanceController {
    ...
    public Object getByContractId(@RequestParam String id, @RequestParam(name = "page", required = false, defaultValue = "0") Integer page, @RequestParam(name = "size", required = false, defaultValue = "5") Integer size){
        Pageable pageable = PageRequest.of(page, size);
